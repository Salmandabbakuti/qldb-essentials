...
define(["require", "exports", "./IonCatalog", "./IonDecimal", "./IonLocalSymbolTable", "./IonParserTextRaw", "./IonSymbols", "./IonType", "./IonTypes", "./IonTimestamp", "./IonText", "./JsbiSupport", "./IntSize"], function (require, exports, IonCatalog_1, IonDecimal_1, IonLocalSymbolTable_1, IonParserTextRaw_1, IonSymbols_1, IonType_1, IonTypes_1, IonTimestamp_1, IonText_1, JsbiSupport_1, IntSize_1) {
    "use strict";
        ...
        fieldName() {
            ...
            if (raw_type === T_IDENTIFIER && (str.length > 1 && str.charAt(0) === '$'.charAt(0))) {
                ...
                if (+tempStr === +tempStr) {
                    ...
                    if (symbol === undefined)
                        throw new Error("Unresolveable symbol ID, symboltokens unsupported.");
                    return symbol;
                }
            }
            return str;
