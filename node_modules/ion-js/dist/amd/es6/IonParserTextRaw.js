...
define(["require", "exports", "./IonText", "./IonText", "./IonTypes", "./JsbiSupport"], function (require, exports, IonText, IonText_1, IonTypes_1, JsbiSupport_1) {
    "use strict";
    ...
    class ParserTextRaw {
        ...
        _skip_triple_quote_gap(entryIndex, end, acceptComments) {
            ...
            let ch = this._in.valueAt(tempIndex);
