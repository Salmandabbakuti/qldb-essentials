...
class Timestamp {
    constructor(localOffset, year, month, day, hour, minutes, seconds) {
...
_TimestampParser._timeParserStates = {
    ...
    [_States.FRACTIONAL_SECONDS]: new _TimeParserState(_States.FRACTIONAL_SECONDS, undefined, {
        "+": _States.OFFSET_POSITIVE,
        "-": _States.OFFSET_NEGATIVE,
        "Z": _States.OFFSET_ZULU
    }),
    ...
    [_States.OFFSET_MINUTES]: new _TimeParserState(_States.OFFSET_MINUTES, 2, undefined),
    [_States.OFFSET_ZULU]: new _TimeParserState(_States.OFFSET_ZULU, 0, undefined),
    [_States.OFFSET_UNKNOWN]: new _TimeParserState(_States.OFFSET_UNKNOWN, 0, undefined),
};
