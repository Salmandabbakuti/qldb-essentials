...
var TransactionExecutor = /** @class */ (function () {
     ...
     */
    function TransactionExecutor(transaction) {
     ...
     */
    TransactionExecutor.prototype.abort = function () {
     ...
     */
    TransactionExecutor.prototype.executeInline = function (statement, parameters) {
        if (parameters === void 0) { parameters = []; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._transaction.executeInline(statement, parameters)];
     ...
     * @throws {@linkcode TransactionClosedError} when the transaction is closed.
     */
    TransactionExecutor.prototype.executeStream = function (statement, parameters) {
        if (parameters === void 0) { parameters = []; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._transaction.executeStream(statement, parameters)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    */
    TransactionExecutor.prototype.getTransactionId = function () {
